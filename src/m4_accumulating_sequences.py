...
def rectangles_from_circles(circles):
    ...
    for k in range(len(circles)):
        upper_left_corner = rg.Point(circles[k].center.x - circles[k].radius, circles[k].center.y - circles[k].radius)
        lower_right_corner = rg.Point(circles[k].center.x + circles[k].radius, circles[k].center.y + circles[k].radius)
        rectangle = rg.Rectangle(upper_left_corner, lower_right_corner)
        seq += [rectangle]
    return seq
